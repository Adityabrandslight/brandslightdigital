...
export const metadata = {
  title: {
    default: "Best E-commerce Website Development Agency | Shopify Experts",
  },
  description: "Build your online store with the best e-commerce website development company. From Shopify to custom solutions, our experts deliver results. Connect with Us",
};
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-16 px-6 py-6 md:grid-cols-2 md:py-12 lg:px-8">
          <div className="order-2 space-y-6 md:order-1 md:space-y-8">
            ...
            <p className="text-lg leading-relaxed text-slate-600 md:max-w-lg md:text-xl">
              High-converting online stores with seamless checkout, mobile-first
              design, and proven sales funnels. Built for speed, security, and
              scalability.
            </p>
            ...
            <div className="grid grid-cols-3 gap-6 pt-4 text-sm">
              <div>
                ...
                <p className="mt-1 text-slate-600">Optimized checkout flow</p>
              </div>
              <div>
          ...
          <div className="order-1 md:order-2">
            <div className="relative">
              ...
              <img
                ...
                alt="E-Commerce website on laptop and mobile"
            ...
            <div className="space-y-6">
              <div className="rounded-xl border border-slate-200 p-8">
                ...
                <p className="mt-3 text-slate-600">
                  Strategic product pages, frictionless checkout, and trust
                  signals designed to turn visitors into paying customers.
                </p>
              </div>
              <div className="rounded-xl border border-slate-200 p-8">
                <h3 className="font-serif text-2xl font-medium">
                ...
                <p className="mt-3 text-slate-600">
                  Over 60% of shopping happens on mobile. We build stores that
                  look and perform beautifully on all devices.
                </p>
              </div>
              <div className="rounded-xl border border-slate-200 p-8">
                <h3 className="font-serif text-2xl font-medium">
                ...
                <p className="mt-3 text-slate-600">
                  Whether Shopify, WooCommerce or custom solutions, we build
                  stores that grow with your business.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6 py-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="mt-3 text-slate-600 md:text-lg">
              Complete e-commerce solutions from setup to launch.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              [
                "Strategy session",
                "Product strategy, target audience, and conversion goals.",
              ],
              [
                "Platform selection",
                "Recommend the best platform for your needs and budget.",
              ],
              [
                "Store design",
                "Mobile-optimized, brand-aligned product pages and flows.",
              ],
              [
              ...
              [
                "Payment integration",
                "Secure payment gateways and tax configurations.",
              ],
              [
                "SEO & marketing",
                "Product schema, collections, and marketing setup.",
              ],
            ...
            {[
              {
                ...
                title: "Petal Pure",
                description: "E-Commerce Skin Care",
                url: "https://petalpureoasis.com/",
              },
              {
                src: "/project/alepe.png",
                title: "Alepe",
                description: "E-Commerce Skin Care",
                url: "https://alepe.in/",
              },
              {
                src: "/project/hiddenhungr.png",
                title: "Hidden Hungr",
                description: "E-Commerce Energy Drink",
                url: "https://hiddenhungr.com/",
              },
              {
                src: "/project/kyundskinn.png",
                title: "kyndskinn",
                description: "E-commerce Skin Care",
                url: "https://kyndskinn.com/",
              },
              {
                src: "/project/krustalloheal.png",
                title: "Krustallo Heal",
                description: "E-Commerce Crystal",
                url: "https://krustalloheal.in/",
              },
      ...
      <section className="bg-[#faf7f2]">
        <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <p className="mt-3 text-slate-600 md:text-lg">
              Structured approach to launching successful online stores.
            </p>
          </div>
            ...
            {[
              {
                ...
                title: "Plan",
                description:
                  "Product strategy, platform selection, and conversion roadmap.",
              },
              {
                step: "02",
                title: "Design",
                description:
                  "Product page templates, collections, and mobile-optimized flows.",
              },
              {
                step: "03",
                title: "Build",
                description:
                  "Platform setup, payment integration, and inventory management.",
              },
              {
                step: "04",
                title: "Launch",
                description:
                  "Testing, analytics, and marketing setup for immediate sales.",
              },
            ].map((phase) => (
              <div
                key={phase.step}
            ...
            <div className="md:flex md:items-center md:gap-10">
              ...
              <blockquote className="mt-8 md:mt-0">
                <p className="font-serif text-2xl leading-relaxed md:text-3xl md:leading-relaxed">
                  "Our conversion rate increased by 35% after the redesign. The
                  mobile experience is now our strongest sales channel."
                </p>
                <footer className="mt-4 text-base text-slate-600">
                  Priya Gupta, E-Commerce Manager
                </footer>
              </blockquote>
            </div>
          </div>
